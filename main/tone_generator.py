...
if __name__ == "__main__":
    ...
    print(math.log(frequency_start, 10))
    print(math.log(frequency_end, 10))
    print(numpy.logspace( math.log( frequency_start, 10 ) , math.log(frequency_end, 10), num_frequencies ) )
